    ...
    >
      <Link to={`/profile/${slug}`}>
        <motion.div
          ...
          whileHover={{ z: 50 }}
          className="relative rounded-3xl overflow-hidden glass-strong border-2 border-border/50 hover:border-primary/60 transition-all duration-500 shadow-2xl"
        >
          ...
          {/* Content */}
          <div className="relative p-6 space-y-4 bg-card/50 backdrop-blur-sm">
            ...
            <p className="text-sm text-foreground/70 line-clamp-2 leading-relaxed">{bio}</p>
